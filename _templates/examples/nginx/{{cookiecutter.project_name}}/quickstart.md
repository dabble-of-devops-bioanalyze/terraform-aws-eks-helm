...
```
cookiecutter \
	git@github.com:dabble-of-devops-bioanalyze/terraform-aws-eks-helm.git \
	--directory _templates/examples/nginx
```
...
cookiecutter(git@github.com:dabble-of-devops-bioanalyze/terraform-aws-eks-helm.git,
        directory=_templates/examples/nginx,
        no_input=True,
